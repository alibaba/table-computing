...
import static com.alibaba.sdb.spi.block.BlockUtil.MAX_ARRAY_SIZE;
import static com.alibaba.sdb.spi.block.BlockUtil.calculateBlockResetBytes;
import static com.alibaba.sdb.spi.block.BlockUtil.calculateBlockResetSize;
import static com.alibaba.sdb.spi.block.BlockUtil.checkArrayRange;
import static com.alibaba.sdb.spi.block.BlockUtil.checkValidPosition;
import static com.alibaba.sdb.spi.block.BlockUtil.checkValidPositions;
import static com.alibaba.sdb.spi.block.BlockUtil.checkValidRegion;
import static com.alibaba.sdb.spi.block.BlockUtil.compactArray;
        ...
        implements BlockBuilder
{
    ...
    {
        long arraysSizeInBytes = (Integer.BYTES + Byte.BYTES) * (long) positions + Integer.BYTES;
    ...
    public long getRegionSizeInBytes(int positionOffset, int length)
    {
        ...
        long arraysSizeInBytes = (Integer.BYTES + Byte.BYTES) * (long) length + Integer.BYTES;
