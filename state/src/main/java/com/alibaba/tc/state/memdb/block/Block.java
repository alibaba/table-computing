...
import static com.alibaba.sdb.spi.block.DictionaryId.randomDictionaryId;

public interface Block
        extends UncheckedBlock
{
    default void appendNullValue()
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default void appendByte(byte aByte)
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default void appendShort(short aShort)
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default void appendInt(int aInt)
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default void appendLong(long aLong)
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default void appendSlice(Slice slice)
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default Block compactRegionToOffheap(int positionOffset, int length)
    {
        return copyRegion(positionOffset, length);
    }

    default Block compactOnOffheap()
    {
        return this;
    }

    default Slice getSlice()
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default Slice getOffsetsSlice()
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default Slice getValuesSlice()
    {
        throw new UnsupportedOperationException(getClass().getName());
    }

    default Slice getValueIsNullSlice()
    {
        throw new UnsupportedOperationException(getClass().getName());
    }
