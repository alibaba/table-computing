...
import com.alibaba.sdb.spi.type.MapType;
...
import static com.alibaba.sdb.spi.block.MapBlockBuilder.buildHashTable;
import static com.alibaba.sdb.spi.block.MapBlockBuilder.verify;
        ...
        implements Block
{
     ...
     * <p>
     * Internal use by this package and com.alibaba.sdb.spi.Type only.
     *
